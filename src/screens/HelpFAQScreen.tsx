...
const FAQ_ITEMS: { title: string; answer: FaqAnswerBlock[] }[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      {
        type: "bullets",
        items: ["Coffee or food", "Drinks", "Walks or runs", "Events, gigs, cinema", "Classes or activities"],
      },
    ],
  },
  {
              ...
              <View key={`bullets-${index}`} style={styles.faqAnswerBulletList}>
                {block.items.map((item) => (
                  <View key={item} style={styles.faqAnswerBulletRow}>
                    ...
                    <Text style={[styles.faqAnswerText, styles.faqAnswerBulletText]}>{item}</Text>
                  </View>
                ))}
              </View>
            );
